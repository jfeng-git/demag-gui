...
class HSControlPanel(QGroupBox):
    ...
    def setup_ui(self):
        ...
        # ALL CONTROLS IN ONE LINE WITH LABELS
        ...
        current_hbox.addWidget(self.current_display)
        controls_hbox.addLayout(current_hbox)
        
        controls_hbox.addSpacing(15)
        
        # Output button
        output_hbox = QHBoxLayout()
        output_hbox.addWidget(QLabel("Output:"))
        ...
        controls_hbox.addLayout(output_hbox)
        
        controls_hbox.addSpacing(15)
        
        # Heater switch button
        heater_hbox = QHBoxLayout()
        heater_hbox.addWidget(QLabel("Heater:"))
        ...
        controls_hbox.addLayout(heater_hbox)
    ...
    def connect_hs(self):
        ...
        try:
            from driver.UDP5303 import UDP5303
